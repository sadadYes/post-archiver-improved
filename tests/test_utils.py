...
from post_archiver_improved.utils import (
    make_http_request, validate_channel_id, sanitize_filename,
    format_file_size, create_backup_filename, download_image
)
...
class TestValidateChannelId:
    ...
    def test_invalid_channel_ids(self):
        ...
        for channel_id in invalid_ids:
            assert not validate_channel_id(channel_id), f"Should be invalid: {channel_id}"
...
class TestFormatFileSize:
    ...
    def test_negative_sizes(self):
        ...
        assert format_file_size(-1024) == "-1024.0 B"  # Negative numbers don't get converted
